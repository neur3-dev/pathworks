...
const SUMMARIZE_SYSTEM_PROMPT = `You are summarizing a multi-turn PathWorks course-creation chat so the assistant can pick up exactly where it left off in a new conversation.
