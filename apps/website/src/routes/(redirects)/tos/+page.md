...
These terms of service are entered into by and between You and PathWorks ("Company," "we," "our," or "us"). The following terms and conditions, together with any documents they expressly incorporate by reference (collectively "Terms of Service"), govern your access to and use of pathworkslearning.com, including any content, functionality, and services offered on or through pathworkslearning.com (the "Website").
