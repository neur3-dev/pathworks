<script>
  ...
  const mcpJsonLines = [
    ...
    '        <span class="text-sky-300">"PATHWORKS_API_URL"</span><span class="text-slate-500">:</span> <span class="text-emerald-300">"https://pathworks-api-domain.invalid"</span><span class="text-slate-500">,</span>',
