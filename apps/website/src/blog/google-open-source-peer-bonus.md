...
After I made [PathWorks](https://git.new/class) open source, a lot of people helped us get traction from the community and soon enough we got noticed by several educators in the community.
...
I want to use this opportunity to thank [Ada Nduka Oyom](https://x.com/Kolokodess) for reaching out to me and recommending [PathWorks](https://git.new/class) internally at Google to receive the Google Open Source Peer Bonus.
