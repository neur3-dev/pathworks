---
title: 'Self-host PathWorks on your Servers'
description: 'On Day 3 of our launch week, we are excited to announce that you can now easily self-host PathWorks on your servers using our pre-built Railway template.'
...
For self-hosting, we have written up a [guide that uses Railway](https://pathworks.neur3.dev/docs/quickstart/self-hosting) to help deploy our stack and you get to manage the servers on Railway as you wish. We hope this is a good step in helping you educate your audience at ease.
