...
const saasDefaults = {
  ...
  connectSrc: [
    'https://*.pathworks-domain.invalid',
    'https://pathworks-domain.invalid',
    'https://pathworks-domain.invalid',
    'https://pathworks-api-domain.invalid',
    'https://pathworks-pgrest-domain.invalid',
    'https://pathworks-play-domain.invalid',
    'wss://*.pathworks-domain.invalid',
    'https://assets.cdn.clsrio.com',
    'https://cdn.plyr.io',
    'https://*.posthog.com',
    'https://umami.hz.oncws.com',
