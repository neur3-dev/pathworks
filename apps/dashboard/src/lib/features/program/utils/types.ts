...
type ProgramListResponse = InferResponseType<typeof pathworks.program.$get>;
type ProgramListSuccess = Extract<ProgramListResponse, { success: true }>;
export type Program = ProgramListSuccess['data'][number];

type ProgramResponse = InferResponseType<(typeof pathworks.program)[':programId']['$get']>;
type ProgramSuccess = Extract<ProgramResponse, { success: true }>;
export type ProgramDetail = ProgramSuccess['data'];

type ProgramMembersResponse = InferResponseType<(typeof pathworks.program)[':programId']['members']['$get']>;
...
type ProgramCoursesResponse = InferResponseType<(typeof pathworks.program)[':programId']['courses']['$get']>;
...
export type ListProgramNewsfeedRequest = (typeof pathworks.program)[':programId']['newsfeed']['$get'];
...
export type CreateProgramNewsfeedRequest = (typeof pathworks.program)[':programId']['newsfeed']['$post'];
export type UpdateProgramNewsfeedRequest = (typeof pathworks.program)[':programId']['newsfeed'][':feedId']['$put'];
export type ReactToProgramNewsfeedRequest =
  (typeof pathworks.program)[':programId']['newsfeed'][':feedId']['react']['$put'];
export type DeleteProgramNewsfeedRequest = (typeof pathworks.program)[':programId']['newsfeed'][':feedId']['$delete'];

export type GetProgramNewsfeedCommentsRequest =
  (typeof pathworks.program)[':programId']['newsfeed'][':feedId']['comments']['$get'];
...
export type CreateProgramNewsfeedCommentRequest =
  (typeof pathworks.program)[':programId']['newsfeed'][':feedId']['comment']['$post'];
export type DeleteProgramNewsfeedCommentRequest =
  (typeof pathworks.program)[':programId']['newsfeed'][':feedId']['comment'][':commentId']['$delete'];

// ─── Goals ───────────────────────────────────────────────────────────────────

export type ListProgramGoalsRequest = (typeof pathworks.program)[':programId']['goals']['$get'];
...
export type CreateProgramGoalRequest = (typeof pathworks.program)[':programId']['goals']['$post'];
export type UpdateProgramGoalRequest = (typeof pathworks.program)[':programId']['goals'][':goalId']['$put'];
export type DeleteProgramGoalRequest = (typeof pathworks.program)[':programId']['goals'][':goalId']['$delete'];

export type MyGoalsRequest = typeof pathworks.program.my.goals.$get;
...
export type GoalsOverviewRequest = typeof pathworks.program.goals.overview.$get;
