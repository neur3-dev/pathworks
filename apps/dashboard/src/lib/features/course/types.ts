...
// Org Courses types
export type GetOrgCoursesRequest = typeof pathworks.organization.courses.$get;
...
export type GetUserEnrolledCoursesRequest = typeof pathworks.organization.courses.enrolled.$get;
...
export type GetRecommendedCoursesRequest = typeof pathworks.organization.courses.recommended.$get;
