 ...
 * to the dashboard service. Marketing apex (pathworks.com) is intentionally separate.
 */
export const TENANT_ROOT_DOMAIN = 'mypathworks.com';

/** The marketing / admin / api zone. */
export const BRAND_ROOT_DOMAIN = 'pathworks.com';
